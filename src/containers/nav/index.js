  ...
  render() {
    return (
      <Navbar collapseOnSelect>
         <a href="https://github.com/excellalabs/labs-website" target="_blank" className="github-corner" alt="View source on Github">
          <svg height={80} width={80} viewBox={"0 0 250 250"} className="github-corner-logo" aria-hidden={true}>
