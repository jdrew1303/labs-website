        ...
        <Grid>
          <Row>
            <Col md={7}>
              ...
              <Button bsStyle="primary" href="https://www.excella.com/dc-full-stack-web-summit-2017" target='_blank'>watch conference videos here <i className='fa fa-arrow-right' aria-hidden='true'></i></Button>
            </Col>
            <Col md={5}>
